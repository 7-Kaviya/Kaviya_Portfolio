  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 md:px-10 md:py-24">
      ...
      <p className="mt-4 max-w-xl text-base text-muted-foreground">
        I'm a fresher looking for internships and entry-level roles. Email is the quickest way to reach me.
      </p>
      ...
      <div className="mt-10 rounded-xl border border-border bg-card p-6">
        <p className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Résumé</p>
...
const channels = [
  ...
  { label: "LinkedIn", handle: "in/kaviya-v", href: "https://linkedin.com/in/kaviya-v" },
